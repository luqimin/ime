...
export abstract class BaseClass<P> implements IMEBase<P> {
    ...
    public async run(): Promise<any> {
        ...
        // beforeTaskRun...
        this.runtime.beforeTaskRun =
            this.beforeTaskRun && (await this.beforeTaskRun(this.params));
        ...
        // taskRunning...
        this.runtime.taskRunning =
            this.taskRunning &&
            (await this.taskRunning(this.runtime, this.params));
        ...
        // afterTaskRun...
        this.runtime.afterTaskRun =
            this.afterTaskRun && (await this.afterTaskRun(this.params));
     ...
     */
    protected beforeTaskRun?(
        params?: P
    ): Promise<beforeTaskRunResult> | beforeTaskRunResult | boolean | void;
    ...
    protected taskRunning?(
        runtime: Runtime,
        params?: P
    ): Promise<taskRunningResult> | taskRunningResult | void;

    /**
     * 运行task结束
     */
    protected afterTaskRun?(
        params?: P
    ): Promise<afterTaskRunResult> | afterTaskRunResult | void;
